...
<div class="nav">
  ...
  <section id="dashboard">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">Student Class Schedule</h2>
      <hr class="star-dark mb-5">
    
    <c:set var="name" value="${C_STUDENT}"/>
      <h3 class="text-center text-uppercase text-secondary mb-0"><span style="color:#17a2b8">Hi <span style="color:#2c3e50">"${name.firstName}"</span>, below is your
      classes schedule</span></h3>
    	  ...
    	  <table align="center" cellpadding="12">
	    		...
	    		<c:forEach var="tempClass" items="${CURRENT_STUD_CLASSES}">
					...
					<tr>
						...
						<td>
							<a id="drop" href="${tempLink}" class="btn btn-info" role="button">Drop Class</a>
