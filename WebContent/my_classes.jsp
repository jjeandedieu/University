...
<div class="nav">
  ...
  <section id="dashboard">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-0">Teacher Class Schedules</h2>
   ...
   <section id="classes">
    <div class="container">
    <c:set var="name" value="${C_TEACHER}"/>
      <h3 class="text-center text-uppercase text-secondary mb-0">Classes Teaching this Semester</h3>
      <div class="row">
    	  ...
    	  <table align="center" cellpadding="12">
	    		...
	    		<c:forEach var="tempClass" items="${CURRENT_TEACH_CLASSES}">
					...
					<c:url var="tempLink" value="UniTeachersController">
						...
						<c:param name="teachId" value="${tempTeachers.id}"/>
